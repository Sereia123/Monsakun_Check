    ...
    return (
      <DndContext  //useDraggable useDroppableが使用可能
        ...
        <div className=" bg-white w-[1000px] h-[600px] mx-auto mt-[2%] p-[10px] border border-gray-400 rounded-xl" > {/*背景*/}
          ...
          <div className='flex'>
            <p className='bg-blue-800 pt-[100px] pl-12 rounded-[50%] w-[250px] h-[250px] text-center ml-0 text-[70px] font-bold mb-2 -translate-x-[100px] -translate-y-[100px] text-white'>Q２</p>
